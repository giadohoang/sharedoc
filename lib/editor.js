...
class Editor {
    ...
    bindDownloadButton() {
        ...
        dlButton.onclick = () => {
            ...
            doanloadLink.innerHtml = "Download File";
            downloadLink.href = textAsURL;
            downloadLink.onclick = this.afterDownLoads;
    ...
    isEmpty(textArr) {
        return textArr.lengh === 1 && textArr[0].length === 0;
    }
    ...
    inserText(value, positions, siteId) {

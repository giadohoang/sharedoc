...
class Version {
     ...
     * 
     * If the incomingCounter is less than we had previously processed, we can 
     * remove it from the exceptions.
     * 
     * Else if the incomingCounter is the operation immediately after the last
     * one we processed, we just incrememnt our counter to reflect that
     * 
     * Else, add an exception for each counter value that we haven't seen yet,
     * and update our counter to match
     * 
     */
    update(version) {

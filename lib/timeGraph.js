...
title = 'Local Insertions, Different Bases and Boundaries (mul = 2, strategy = random)';
Plotly.newPlot('g0', data, { title: title, height: 600 });


//local deletions

funcs = [[Util.deleteRandom, 'random'], [Util.deleteEnd, 'at end'], [Util.deleteEnd, 'at begining']];
data = [];
...
title = 'Remote Insertions, Different Bases and Boundaries (mult = 2, strategy = ramdom)';
